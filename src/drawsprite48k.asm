...
;UpdateSprite_go:
	...
	push bc						;guardamos los registros 
	push de
	push hl
	call InvalidateTiles		
	pop hl						;recuperamos todos los registros y seguimos
	pop de
	pop bc
	ld a, l
	cp c
...
lineloop_24_noshift:
	...
	ld a, (hl)		; repeat for the next column
	or d
	ld (hl), a
	inc l
