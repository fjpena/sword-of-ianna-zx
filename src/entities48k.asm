...
;	call MUSIC_Load
	...
	xor a 					;cargamos musica 0 death player
	jp Music_Play

; 	ld b, 50			;180					<<<<<<<<<<<<<pausa musica gameover
;gameover_music_loop:
;    halt
...
; Update player sprite caida, based on the new position
; IY points to the sprite structure

player_updatesprite_caida:
	ld a, (newx)
;	ld b, a
	ld (iy+3),a
	ld a, (newy)
...
;	ld a, (iy+4)
;	cp 97
3;	jp nc, entity_canhang_upleft_noway ; do not try when we are down already!
...
entity_fall_continue:
	...
	ld a, (current_level)	;excepcion para el nivel 3 pantalla 5,0 donde hay un enemigo doble que cae
	cp 3
	jr nz, comprobarcaida
	ld a, (current_levelx)
	cp 5
	jr nz, comprobarcaida
	ld a, (current_levely)
	...
	ld bc, $1606
	ld de, $0304
	call InvalidateTiles	;invalidamos la seccion de 3x4 dentro de la jaula

comprobarcaida
	ld hl, spritecaida1
	ld a, (spritegravity)
	cp 2
	jr z, comprobarcaida2
	jr c, comprobarcaida1
comprobarcaida3
	inc hl
comprobarcaida2
	inc hl
comprobarcaida1
	ld a, (hl)
	and a
	jp nz, player_updatesprite_caida
	inc (hl)
	jp player_updatesprite
